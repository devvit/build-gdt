...
git clone --depth 1 -b 4.5 --recursive https://github.com/godotengine/godot
cd godot
gd_dir=$(pwd)
...
git clone -b v1.5.3 --depth 1 --recursive https://github.com/limbonaut/limboai modules/limboai
