...
git clone --depth 1 -b 4.4.1-stable --recursive https://github.com/godotengine/godot
cd godot
gd_dir=$(pwd)
...
scons platform=macos arch=arm64 target=editor generate_bundle=yes $qjs
